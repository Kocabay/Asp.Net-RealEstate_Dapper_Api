...
namespace RealEstate_Dapper_Api.Controllers
{
    ...
    {
        private readonly ILast5ProductRepositories _lastProductRepository;

        public EstateAgentLastProductsController(ILast5ProductRepositories lastProductRepository)
        {
