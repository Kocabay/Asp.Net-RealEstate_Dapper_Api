...
namespace RealEstate_Dapper_Api.Controllers
{
    ...
    public class PropertyAmenitiesController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> ResultPropertAmenityByStatusTrue(int id)
        {
            var values =await _propertyAmenityRepository.ResultPropertAmenityByStatusTrue(id);
            return Ok(values);
        }
    }
}
