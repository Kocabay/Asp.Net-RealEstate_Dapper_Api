...
namespace RealEstate_Dapper_Api.Repositories.ContactRepositories
{
    public class ContactRepository : IContactRepository
    {
        ...
        public void CreateEmployee(CreateContactDto createContactDto)
        {
        ...
        public Task<List<ResultContactDtos>> GetAllContactAsync()
        {
            throw new NotImplementedException();
        }
        ...
        public async Task<List<Last4ContactResultDto>> GetLastFourContanctAsync()
        {
